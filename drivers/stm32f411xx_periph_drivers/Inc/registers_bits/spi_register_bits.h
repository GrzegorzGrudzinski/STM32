...
union SPI_CR1_t
{
	struct {
		...
		const uint32_t RESERVED	: 16;	/*!< bits 16-31 >*/
	};
	__vo uint32_t reg;
};
...
union SPI_CR2_t
{
	struct {
		...
		const uint32_t RESERVED0	: 1;	/*!< bit 3>*/
		...
		const uint32_t RESERVED1	: 8;	/*!< bits 8-15 >*/
		const uint32_t RESERVED2	: 16;	/*!< bits 16-31 >*/
	};
	__vo uint32_t reg;
};
...
union SPI_SR_t
{
	struct {
		...
		const uint32_t RESERVED	: 7;	/*!< bits 9-15 >*/
		const uint32_t RESERVED1	: 16;	/*!< bits 16-31 >*/
...
union SPI_I2SCFGR_t
{
	struct {
		...
		const uint32_t RESERVED	 : 1;	/*!< bit 6 >*/
		...
		const uint32_t RESERVED0	 : 4;	/*!< bits 12-15 >*/
		const uint32_t RESERVED1	 : 16;	/*!< bits 16-31 >*/
...
union SPI_I2SPR_t
{
	struct {
		...
		const uint32_t RESERVED	: 6;	/*!< bits 10-15 >*/
		const uint32_t RESERVED1	: 16;	/*!< bits 16-31 >*/
